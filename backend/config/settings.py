...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-dev-key-nie-uzywaj-na-produkcji")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DEBUG", "True").lower() in ("1", "true", "tak")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "smart_apartment"),
